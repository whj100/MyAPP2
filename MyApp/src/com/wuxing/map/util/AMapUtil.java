...
public class AMapUtil {
	...
	//路径规划方向指示和图片对
	public static int getBikeActionID(String actionName) {
		
		if (actionName == null || actionName.equals("")) {
			return R.drawable.bike_check;
		}
		...
		public static int getWalkActionID(String actionName) {
			...
			if (actionName == null || actionName.equals("")) {
				if (LuXianActivity.METHOD == 3) {
					return R.drawable.dir13;
				}else if (LuXianActivity.METHOD == 1) {
					return R.drawable.bike_gray;
				}
			}
			if ("左转".equals(actionName)) {
				return R.drawable.dir2;
